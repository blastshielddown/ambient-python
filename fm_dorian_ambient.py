...
if __name__ == "__main__":
    print("Dorian Mode Electric Keyboard - 3 Minute Ambient Piece")
    print("4 chords, 11.71 seconds each (4 measures at 82 BPM)")
    ...
    for note_name, freq in unique_notes.items():
        ...
        # Add rhythmic delay effect - half-measure delay (1.33 seconds at 90 BPM)
        # Create multiple delay taps for repeating echoes that decay over time
        ...
        # Connect to audio output but don't trigger yet - gate starts at 0 (silent)
        final_voice.play()
    ...
    num_chords = int(total_duration / chord_duration)  # About 11 chords
    ...
    for seq_idx, chord_idx in enumerate(chord_sequence):
        ...
        # Re-trigger drone every 5 measures (5 * 4 beats * 60s / 90 BPM = 13.33 seconds)
    ...
    print("3-minute Dorian ambient piece complete!")